...
(function () {
  ...
  var ZH = {
    ...
    "skill.homeText": "下载开源 MatrixOne Skill：独立分支、完整校验、单独授权合并。使用你自己的数据库和现有 SQL 工具。",
    "skill.homeLink": "下载 Agent Skill →",
    "skill.navHome": "首页",
    "skill.navEvidence": "实测结果",
    "skill.download": "下载 Skill",
    "skill.kicker": "开源 AGENT SKILL · v0.1.0",
    "skill.title": "让 Agent 提出修改。<br><span class=\"grad\">由你决定什么进入生产。</span>",
    "skill.intro": "给 Codex 一套可复用的 MatrixOne 工作流：创建分支、修改数据、查看差异、校验每一条改动，最后只合并经过批准的提案。",
    "skill.downloadZip": "下载 Skill ZIP",
    "skill.installLink": "安装到你的项目",
    "skill.meta": "MIT 协议 · Markdown + SQL 指南 · 无需专用 MCP · 无运行时遥测",
    "skill.packageTitle": "Agent 可以照着执行的工作流。",
    "skill.file1": "操作流程与停止条件",
    "skill.file2": "快照、分支、Diff、PICK 与 MERGE",
    "skill.file3": "权限、审批与资源限制",
    "skill.file4": "绑定具体提案的审核报告",
    "skill.readSource": "安装前查看全部指令 →",
    "skill.boundaryTitle": "Skill 指导行为，权限落实边界。",
    "skill.boundary": "提案 Agent 应只能写入自己的分支。生产写入和合并凭据由独立操作者或服务持有。分支隔离数据修改；重任务仍需资源限制，或独立的工作实例。",
    "skill.installKick": "复用你现有的工具",
    "skill.installTitle": "安装一次，连接你自己的 MatrixOne。",
    "skill.step1Title": "下载并检查",
    "skill.step1": "解压并阅读指令。包内没有可执行安装器、数据库密码或自动连接操作。",
    "skill.step2Title": "放入你的项目",
    "skill.step2": "Codex 用户将解压后的目录放到下面的位置，然后打开项目；若未出现，重启 Codex。其他 Agent 请使用其支持的 Skill 目录。",
    "skill.installDocs": "Codex 官方 Skill 安装指南 →",
    "skill.step3Title": "让 Agent 准备可审核的提案",
    "skill.step3": "使用现有 MySQL 客户端或数据库工具，以及仅能写入分支的凭据。先用少量可丢弃的数据检查当前 MatrixOne 版本。",
    "skill.toolsKick": "现在：SKILL + 现有客户端",
    "skill.toolsTitle": "什么时候需要额外的工具？",
    "skill.localTitle": "由操作者审核和合并",
    "skill.local": "Skill 配合 MySQL 客户端即可开始。操作者分配受限的分支权限，并在独立会话里合并已审核的改动。无需专用 MCP 服务。",
    "skill.available": "当前下载包已提供流程指南",
    "skill.serviceTitle": "无人值守或多人使用",
    "skill.service": "增加本地 CLI 或服务，由它保管凭据，强制执行工作区范围、提案冻结、审批、资源限制和合并恢复。MCP 是可选接口之一。此版本不包含该执行服务。",
    "skill.future": "工作流需要时再构建",
    ...
    "skill.feedbackText": "欢迎自愿提交公开使用反馈：你的工作负载、MatrixOne 版本、分支 → 审核 → 合并是否跑通，以及遇到的问题。请勿包含凭据、私有数据或客户信息。",
    "skill.feedbackLink": "分享使用体验",
    "skill.proofLink": "查看千万行实测",
    "skill.proofNote": "已公开的实验使用合成数据及 20 个 Codex 编写的 SQL 方案，验证了数据库操作流程；它不等同于完整的生产权限边界测试。",
    "skill.footer": "在分支中修改，完整审核，再授权合并。",
    'nav.features': '产品',
    'nav.how': '工作原理',
    'nav.docs': '文档',
    'nav.usecases': '应用场景',
    ...
    'hero.cta1': '观看 60 秒实测演示',
    'hero.cta2': '开始构建',
    'hero.support': '数据库内置的数据 Git 工作流。基于 MatrixOne 构建。',
    'film.eyebrow': '真实数据库实测',
    'film.title': '1,000 万商品。<br>20 个 Codex Agent。',
    'film.length': '60 秒',
    'film.download': '下载演示视频',
    'film.resultLabel': '已批准并合并的行',
    'film.promise': '进入主表的价格改动为 0，未经审查的改动为 0。',
    'film.note': '合成数据上的实测回放。20 个 Codex 任务编写 SQL，最多 3 个执行器同时运行。价格违规为主动注入，用于验证审批规则。',
    'film.try': '亲手体验分支、Diff 与合并',
    'film.evidence': '查看实测结果与方法 →',
